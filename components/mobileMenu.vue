    ...
    <div class="fixed inset-0 flex z-40">
      ...
      <div v-click-outside="externalClick" class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
        ...
        <div class="mt-5 flex-1 h-0 overflow-y-auto">
          <nav class="px-2">
            <div class="space-y-1">
              <a href="#" class="group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md text-gray-900 bg-gray-100 hover:text-gray-900 hover:bg-gray-100">
                <!-- Heroicon name: home -->
              ...
              <a href="#" class="group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50">
