         ...
         <div slot-scope="{ currentRefinement, isSearchStalled, refine }" class="relative z-0 flex-1 px-2 flex items-center justify-center sm:absolute sm:inset-0">
            <div class="max-w-s w-full">
              ...
              <div class="relative">
                ...
                <input v-model="currentRefinement" @input="refine($event.currentTarget.value)" name="search" id="search" class="appearance-none min-w-0 w-full bg-white border border-gray-300 py-2 px-4 pl-10 pr-3 text-base leading-6 rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline focus:placeholder-gray-400 transition duration-150 ease-in-out sm:max-w-xs" placeholder="Search" type="search">
              </div>
            </div>
          </div>
